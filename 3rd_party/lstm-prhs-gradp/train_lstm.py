...
from lstm_prhs_gradp import ElementwiseLSTM, load_sequence_dataset


# Legacy CLI-only training used direct arguments such as --epochs, --lr, and
# --hidden. New experiments use config.yaml plus --set overrides so LSTM studies
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train an element-wise LSTM from prhs to gradp.")
...
def main() -> None:
    ...
    dataset, stats, pairs = load_sequence_dataset(
    ...
    print(f"hidden_channels={model_cfg['hidden_channels']} n_lstm_layers={model_cfg['n_lstm_layers']} n_mlp_hidden_layers={model_cfg['n_mlp_hidden_layers']}")
